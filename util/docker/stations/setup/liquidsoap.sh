...
wget -O /tmp/liquidsoap.deb "https://github.com/savonet/liquidsoap-release-assets/releases/download/v2.4.2/liquidsoap-dbgsym_2.4.2-debian-trixie-ocaml4.14.2-1_${ARCHITECTURE}.deb"
