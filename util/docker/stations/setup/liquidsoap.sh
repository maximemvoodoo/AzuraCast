...
wget -O /tmp/liquidsoap.deb "https://github.com/savonet/liquidsoap-release-assets/releases/download/v2.4.1/liquidsoap-minimal_2.4.1-ubuntu-noble-ocaml4.14.2-1_${ARCHITECTURE}.deb"
